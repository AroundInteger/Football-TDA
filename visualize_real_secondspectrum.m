...
% Load data using our fixed JSON function
[home_positions, away_positions, timestamps, metadata] = load_secondspectrum_fixed(data_file, 1000);
...
% Plot 1: Heatmap of player positions (fixed)
subplot(2, 4, 1);
...
if sum(valid_positions) > 0
    % Use scatter plot instead of histogram2 to avoid errors
...
% Plot 2: Heatmap of away team positions (fixed)
subplot(2, 4, 2);
