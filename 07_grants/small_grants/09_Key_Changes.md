...
1. **Preliminary Results Substantially Strengthened**:
   - Single-match validation → 11-match validation (1 optical + 10 broadcast tracking)
   - 523 H1 loops → 5,038 H1 loops across 1,650 analysis frames
...
4. **Paper Status Updated**:
   - Paper 1: ArXiv preprint (Brown et al., 2026), submitted before grant application
