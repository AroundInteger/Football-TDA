...
| `review-tda-football-papers.md` | **TDA Football only:** Paper A (JACT) + Paper B (JSS) scope, pipeline, grant alignment, Mode D |
| `abstract-structure-guide.md` | **PEF empirical:** five-part abstract skeleton + sentence-level digestibility rules |
| `abstract-structure-guide-tda.md` | **TDA Football:** Paper A & B abstract skeletons + sentence-level rules |
