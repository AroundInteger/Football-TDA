...
the team level, so the two surviving envelopes persist over a wide band
...
The tactical level sits close to that floor. In the ten-match sample, 40.6\% of frames have four or fewer
