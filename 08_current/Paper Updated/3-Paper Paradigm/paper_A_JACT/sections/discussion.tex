...
Addressing question~\ref{q:levels}, the three $H_0$ regimes
...
Addressing question~\ref{q:distinct}, the two levels are not measuring
...
Addressing question~\ref{q:validity}, the preliminary answer is yes:
