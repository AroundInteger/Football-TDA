...
**Innovation**: Hierarchical clustering with distance-based cutoff for resolving H0 artefact in persistent homology analysis

**Technical Details**:
- Method: Single-linkage hierarchical clustering with 1.0-metre cutoff distance
...
**Patent Claims**:
1. A method for analysing team formations comprising:
...
2. The method of claim 1, wherein the cutoff distance is between 0.5 and 2.0 metres
...
- **Useful**: Resolves critical H0 artefact in sports analytics
...
- Result: Prevents H1 = 0 artefact in formation complexity analysis
...
- Result: Nash equilibrium at 11.44 vs 12.90 metres

**Patent Claims**:
1. A method for analysing competitive balance comprising:
...
**Innovation**: Optimised algorithms for real-time TDA computation
...
- **Non-obvious**: Not obvious to optimise TDA for real-time sports analysis
...
- **Specialisation**: Software/algorithms patents
...
The GPS-aware clustering method represents the strongest patent candidate, with high novelty and clear commercial applications. A provisional patent filing this week would provide 12-month protection whilst allowing time to evaluate commercial interest and refine the patent strategy.
