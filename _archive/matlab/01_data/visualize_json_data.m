% Visualize Real SecondSpectrum JSON Data
% This script creates key visualizations for the real GPS data

clear; clc; close all;

fprintf('=== Real SecondSpectrum JSON Data Visualization ===\n\n');

%% Step 1: Load real data
fprintf('Step 1: Loading real SecondSpectrum JSON data...\n');

% File path
data_file = '/Users/iMacPro/Documents/GitHub/Football-TDA/FieldTest/g2293068_SecondSpectrum_Data copy.txt';

% Load data using our custom JSON function
[home_positions, away_positions, timestamps, metadata] = load_secondspectrum_json(data_file, 1000);
...
sgtitle('Real SecondSpectrum JSON Data Analysis');
...
sgtitle('Detailed SecondSpectrum JSON Data Analysis');

%% Step 4: Export visualizations
fprintf('\nStep 4: Exporting visualizations...\n');

% Save figures
saveas(gcf, 'secondspectrum_json_detailed_analysis.png');
saveas(gcf-1, 'secondspectrum_json_overview.png');

% Save data
output_dir = './secondspectrum_json_results';
...
fprintf('Successfully created comprehensive visualizations of real SecondSpectrum JSON data!\n');
...
fprintf('\nThe real JSON data has been successfully analyzed and visualized!\n');
