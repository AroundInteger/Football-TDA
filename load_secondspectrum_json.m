function [home_positions, away_positions, timestamps, metadata] = load_secondspectrum_json(filename, max_rows)
% LOAD_SECONDSPECTRUM_JSON Load and parse SecondSpectrum JSON data
% 
% Inputs:
